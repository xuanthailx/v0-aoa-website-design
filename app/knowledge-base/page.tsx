  ...
  const articles = [
    {
      ...
      description:
        'Learn the basics of uploading documents and using the chat interface.',
    ...
    },
    {
      ...
      description:
        'Tips and tricks for uploading documents in various formats.',
      category: 'documents',
      views: 856,
    },
    {
      ...
      description:
        'How the AI assistant processes your documents and generates answers.',
      category: 'ai',
      views: 642,
    },
    {
      ...
      description:
        'Organize and maintain your documents for better search results.',
      category: 'documents',
      views: 523,
    },
    {
      ...
      description:
        'Master the search functionality to find exactly what you need.',
      category: 'search',
      views: 789,
    },
    {
          ...
          <div className="mb-8 flex flex-wrap gap-2">
            {categories.map((category) => (
              <Button
                ...
                className={
                  selectedCategory === category.id ? '' : 'bg-transparent'
                }
              >
                {category.label}
              </Button>
