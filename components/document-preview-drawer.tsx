      ...
      <div className="w-full max-w-2xl bg-background rounded-t-lg shadow-lg max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-background border-b border-border p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Uploaded by {document.uploadedByName} on {document.createdAt.toLocaleDateString()}
            </p>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`font-medium capitalize ${getStatusColor(document.status)}`}>{document.status}</span>
          </div>
            ...
            <div className="space-y-4">
              {!showRejectForm ? (
                <div className="flex gap-3">
                  <Button className="flex-1 gap-2" onClick={handleApprove} disabled={isSubmitting}>
